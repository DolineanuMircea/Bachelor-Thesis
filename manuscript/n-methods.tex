...
With these constraints in mind, PIC codes can be used without much thought for what happens inside them. However, good knowledge about the method and the specific implementation you are using are useful in order to understand the causes of any problem or unphysical solution that might arise.
