...
\end{equation}
Details about the actual derivation and how to apply this definition in particular cases is found in~\cite{belinfanteCurrentDensityElectric1940} and~\cite{humbletMomentImpulsionOnde1943}.
\end{document}
