...
The~\cref{fig:2-stream-instability-1,fig:2-stream-instability-2} illustrate this effect in phase space. The images were obtained through a Particle in Cell simulation. Red points represent the particles going to the right, while blue points represent the particles going to the left.
