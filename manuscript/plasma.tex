...
\begin{equation}
  \vb{k}\vdot\vb{E} = 4\pi\vb{k}\vdot\vb{E} \left(\frac{q_{1}^2 N_{1}\vb{k}\vdot\vb{E}}{m_{1} (\omega - \vb{k}\vdot\vb{V_{1}})^2} + \frac{q_{2}^2 N_{2}\vb{k}\vdot\vb{E}}{m_{2} (\omega - \vb{k}\vdot\vb{V_{2}})^2}\right)\,,
\end{equation}
or, rather
